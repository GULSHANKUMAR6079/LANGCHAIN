...
class Review(TypedDict):
    ...
    pros:Annotated[Optional[list[str]],"Write down all the pros of this review in list"]
    cons:Annotated[Optional[list[str]],"Write down all the cons of this review in list"]
